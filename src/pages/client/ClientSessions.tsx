...
const ClientSessions: React.FC = () => {
    ...
    return (
      <div className="flex items-center justify-center py-12">
        <div className="text-center">
          ...
          <p className="text-fixes-heading-dark text-base">Loading sessions...</p>
        </div>
      </div>
    );
  }
  ...
  return (
    <div className="space-y-5 px-4 sm:px-6 bg-[#F8F9FA]">
      {/* Header */}
      ...
      <div className="bg-white rounded-xl p-3 border border-fixes-heading-dark flex flex-col sm:flex-row items-center sm:items-stretch gap-3 shadow-sm">
        {/* Stats Sections */}
        <div className="flex-1 grid grid-cols-2 sm:grid-cols-4 gap-3 sm:gap-0 sm:divide-x sm:divide-neutral-700">
          ...
          <div className="flex flex-col items-center px-2">
            <div className="flex items-center gap-2 mb-1">
              ...
              <span className="text-fixes-heading-dark text-sm">Missed</span>
            </div>
            <p className="text-lg font-black text-black">
        ...
        <button
          onClick={handleBookNewSession}
          className="bg-fixes-accent-purple text-black px-4 py-2 rounded-xl hover:bg-fixes-accent-blue transition-colors duration-200 flex items-center justify-center gap-2 min-h-[44px] mb-3 sm:mb-0 sm:mr-6"
          aria-label="Book a new therapy session"
        >
          <Plus className="w-5 h-5" />
          <span>Book Session</span>
  ...
  <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
    ...
    <div className="bg-white rounded-xl p-3 border border-fixes-heading-dark text-center shadow-sm">
...
{/* Book Session Button */}
        <button
          onClick={handleBookNewSession}
          className="bg-fixes-accent-purple text-black px-4 py-2 rounded-xl hover:bg-fixes-accent-blue transition-colors duration-200 flex items-center justify-center gap-2 min-h-[44px] mb-3 sm:mb-0 sm:mr-6 mx-auto mt-3 block md:hidden"
          aria-label="Book a new therapy session"
        >
          <Plus className="w-5 h-5" />
          <span>Book Session</span>
      ...
      <div className="space-y-3">
        {paginatedSessions.length > 0 ? (
          paginatedSessions.map((session) => (
            <div
              key={session.id}
              className="bg-white rounded-xl p-3.5 border border-fixes-heading-dark hover:shadow-md transition-colors duration-200"
            ...
            >
              <div className="flex flex-col sm:flex-row sm:items-start gap-2.5">
                ...
                <div className="flex-1 space-y-1">
                  <h3 className="text-black font-black text-base truncate">
                  ...
                  {session.notes && (
                    <button
                      ...
                      className="text-fixes-heading-dark text-sm text-left hover:text-black transition-colors duration-200"
          ...
          <div className="bg-white rounded-xl p-3.5 text-center border border-fixes-heading-dark shadow-sm">
            <div className="w-10 h-10 bg-fixes-accent-purple/10 rounded-full flex items-center justify-center mx-auto mb-3">
            ...
            <button
              ...
              className={`px-3 py-1.5 rounded-lg text-sm min-w-[40px] min-h-[40px] ${
                currentPage === page
                  ...
                  : 'bg-white border border-fixes-heading-dark text-fixes-heading-dark hover:bg-neutral-100 hover:text-black'
              } transition-colors duration-200`}
