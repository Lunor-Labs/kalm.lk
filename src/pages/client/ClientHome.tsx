  ...
  <div className="bg-transparent rounded-3xl p-8">
    <div className="flex items-center justify-between">
          ...
          {quickActions.map((action, index) => {
            ...
            return (
              <button
                ...
                className="group bg-white rounded-xl p-6 border border-fixes-heading-dark hover:shadow-lg transition-all duration-300 hover:-translate-y-2 text-left"
              >
          ...
          {quickActions.map((action, index) => {
            ...
            return (
              <button
                key={index}
                onClick={action.action}
                className="group bg-white rounded-xl p-6 border border-fixes-heading-dark hover:shadow-lg transition-all duration-300 hover:-translate-y-2 text-center"
              >
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-6 md:gap-8">
        {/* Upcoming Sessions */}
        <div className="bg-white rounded-xl p-4 sm:p-6 border border-fixes-heading-dark shadow-sm">
      ...
      <div
        ref={wellnessTipRef}
        className={`bg-white rounded-xl p-6 border border-fixes-heading-dark shadow-sm relative overflow-hidden
