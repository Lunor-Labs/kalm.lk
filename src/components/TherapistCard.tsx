    ...
    <div className="group bg-black/50 backdrop-blur-sm rounded-3xl overflow-hidden shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-2 border border-cream-200/100 flex flex-col">
      ...
      <div className="p-6 flex flex-col flex-1">
        <div className="text-center mb-4">
          <h3 className="text-lg font-semibold text-white mb-1">{therapist.name}</h3>
          <p className="text-primary-500 font-medium text-sm">{therapist.specialty}</p>
        </div>

        <div className="space-y-3 mb-6">
          <div>
            <p className="text-xs text-neutral-400 mb-2 font-bold">
              Languages:
