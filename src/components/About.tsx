...
const About: React.FC = () => {
  return (
    <section id="about" className="py-8 lg:py-12 bg-[#0e100b] relative">
        ...
        <div className="grid lg:grid-cols-2 gap-8 items-center">
          <div className="space-y-6">
            <div className="flex items-start space-x-4">
              <div className="flex-shrink-0 w-10 h-10 bg-emerald-900/20 rounded-xl flex items-center justify-center">
            ...
            <div className="flex items-start space-x-4">
              <div className="flex-shrink-0 w-10 h-10 bg-cyan-900/20 rounded-xl flex items-center justify-center">
            ...
            <div className="flex items-start space-x-4">
              <div className="flex-shrink-0 w-10 h-10 bg-amber-900/20 rounded-xl flex items-center justify-center">
          ...
          <div className="relative">
            ...
            />
            <div className="absolute inset-0 bg-gradient-to-t from-primary-500/30 to-transparent rounded-3xl"></div>
          </div>
        </div>
      </div>
    </section>
